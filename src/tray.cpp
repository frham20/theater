...
namespace Theater
{
	namespace
	{
		...
		//constexpr GUID TRAY_GUID                  = { 0x59cdfa40, 0xdb33, 0x44fd, 0x99, 0x24, 0x95, 0x13, 0x6c, 0x3e, 0xef, 0x2b };
	...
	bool Tray::MessageWindowCreate()
	{
		...
		this->messageWindow = ::CreateWindowExW(0, TRAY_WINDOWCLASS_NAME, TRAY_WINDOW_NAME, 0, 0, 0, 0, 0, HWND_MESSAGE, nullptr, nullptr, nullptr);
