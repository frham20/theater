...
static bool Dimmer_WindowsCreate()
{
	...
	for ( auto& monitor : s_monitors )
	{
		...
		monitor.hwnd = ::CreateWindowExW( exStyle, DIMMER_WINDOWCLASS_NAME, DIMMER_WINDOW_NAME, style, monitor.rc.left,
		                                  monitor.rc.top, monitor.rc.right - monitor.rc.left,
		                                  monitor.rc.bottom - monitor.rc.top, nullptr, nullptr, hInstance, nullptr );
